...
class CartControllerTest {
    ...
    void testListItems() throws Exception {
        ...
        when(cartService.listItems(userId)).thenReturn(null);
    ...
    @Test
    @WithMockUser
    void testGetCart_invalidUUID() throws Exception {
    ...
    @Test
    @WithMockUser
    void testListItems_emptyResponse() throws Exception {
    ...
    @Test
    @WithMockUser
    void testGetCart_validUser() throws Exception {
    ...
    @Test
    @WithMockUser
    void testListItems_valid() throws Exception {
    ...
    void testGetCart_withData() throws Exception {
        ...
        UUID userId = UUID.randomUUID();
        CartView mockCart = new CartView();
